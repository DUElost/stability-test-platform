...
| CodeBuddy **IDE**（4.11.3，GUI） | `AGENTS.md`（子目录**只装载 scoped `AGENTS.md`、根不注入**——2026-09-11 人工探针 Q1=否/Q2=是/Q3=一次，**Zcode 同形态**，与上方 CLI 相反） | 共享约定入口；无脚本通道；可发现性由 scoped 根指针覆盖；**Registry CLI 未 dogfood、未转正** |
