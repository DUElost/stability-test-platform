...
共 **247** 个读取名（`backend/**`，不含 `backend/agent/scripts/**`；含 ADR-0042 Settings 字段）：**219** 个已在 `.env*.example` 登记，**28** 个声明为内部（理由见下节）。
...
| `FINISHTEST_ENTRY` | `-` | — | 测试 | `backend/agent/tests/test_finish_sigterm_tmp_cleanup_2980.py:44` |
| `FINISHTEST_MARKER` | `-` | — | 测试 | `backend/agent/tests/test_finish_sigterm_tmp_cleanup_2980.py:45` |
| `FINISHTEST_TMP` | `-` | — | 测试 | `backend/agent/tests/test_finish_sigterm_tmp_cleanup_2980.py:74` |
...
| `REDIS_PING_TIMEOUT` | `3.0` | ✅ | 运行时 | `backend/main.py:123` |
| `REDIS_URL` | `redis://localhost:6379/0` | ✅ | 运行时 | `backend/main.py:166` |
...
| `SAQ_QUEUE_NAME` | `stp` | ✅ | 运行时 | `backend/main.py:236` |
...
| `STP_SKIP_INFRA_CHECK` | `0` | ✅ | 运行时 | `backend/main.py:207` |
