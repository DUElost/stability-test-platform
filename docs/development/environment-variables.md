...
| 变量 | 默认 | 示例 | 类别 | 首个读取点 |
|---|---|---|---|---|
| `ADB_PATH` | `adb` | ✅ | 运行时 | `backend/agent/main.py:794` |
...
| `API_URL` | `http://127.0.0.1:8000` | ✅ | 运行时 | `backend/agent/main.py:722` |
...
| `AUTO_REGISTER_HOST` | `false` | ✅ | 运行时 | `backend/agent/main.py:758` |
| `AUTO_REGISTER_MAX_RETRIES` | `0` | ✅ | 运行时 | `backend/agent/main.py:775` |
| `AUTO_REGISTER_RETRY_DELAY` | `10` | ✅ | 运行时 | `backend/agent/main.py:776` |
...
| `LOG_LEVEL` | `INFO` | ✅ | 运行时 | `backend/agent/main.py:85` |
...
| `MOUNT_POINTS` | `` | ✅ | 运行时 | `backend/agent/main.py:793` |
| `PATROL_STALL_BATCH_LIMIT` | `100` | ✅ | 运行时 | `backend/core/settings/scheduler.py:47` |
| `PLAN_RUN_RETENTION_DAYS` | `3` | ✅ | 运行时 | `backend/core/settings/scheduler.py:53` |
| `POLL_INTERVAL` | `5` | ✅ | 运行时 | `backend/agent/main.py:792` |
...
| `SCHEDULE_DEDUP_WINDOW_SECONDS` | `60` | ✅ | 运行时 | `backend/core/settings/scheduler.py:54` |
...
| `STP_JOB_WORKER_POOL_SIZE` | `50` | ✅ | 运行时 | `backend/agent/main.py:1301` |
| `STP_LOCAL_DISK_MONITOR_INTERVAL_SECONDS` | `300` | ✅ | 运行时 | `backend/agent/main.py:859` |
| `STP_LOCAL_DISK_SPILL_TARGET` | `70` | ✅ | 运行时 | `backend/agent/main.py:861` |
| `STP_LOCAL_DISK_SPILL_THRESHOLD` | `80` | ✅ | 运行时 | `backend/agent/main.py:860` |
| `STP_LOG_ARCHIVE_GRACE_SECONDS` | `1800` | ✅ | 运行时 | `backend/agent/main.py:843` |
| `STP_LOG_ARCHIVE_INTERVAL_SECONDS` | `3600` | ✅ | 运行时 | `backend/agent/main.py:842` |
...
| `STP_RECOVERY_SYNC_INTERVAL_SECONDS` | `60` | ✅ | 运行时 | `backend/agent/main.py:1365` |
...
| `STP_WATCHER_AEE_RECONCILE_BURST_INTERVAL_SECONDS` | `60` | ✅ | 运行时 | `backend/agent/main.py:920` |
| `STP_WATCHER_AEE_RECONCILE_BURST_ROUNDS` | `5` | ✅ | 运行时 | `backend/agent/main.py:921` |
| `STP_WATCHER_AEE_RECONCILE_ENABLED` | `true` | ✅ | 运行时 | `backend/agent/main.py:918` |
| `STP_WATCHER_AEE_RECONCILE_HOSTS` | `` | — | 运行时 | `backend/agent/aee/reconciler.py:185` |
| `STP_WATCHER_AEE_RECONCILE_INTERVAL_SECONDS` | `180` | ✅ | 运行时 | `backend/agent/main.py:919` |
| `STP_WATCHER_AEE_SUBDIR_LAYOUT` | `stp` | ✅ | 运行时 | `backend/agent/aee/paths.py:194` |
| `STP_WATCHER_ENABLED` | `true` | ✅ | 运行时 | `backend/agent/main.py:93` |
| `STP_WATCHER_PLAN_DEFAULT` | `true` | ✅ | 运行时 | `backend/agent/main.py:94` |
