...
> **Living（2026-08-09）**：正文「15.4 / 15.4 CIFS」= **中心存储角色**（目标态）。口头 CIFS/NFS 都指此角色。现网过渡 UNC 在控制面同机 15.253（2026-08-13 起控制面 IP 由 8.202 变更）。别称对照：[2026-storage-roles-and-aliases.md](../design/2026-storage-roles-and-aliases.md)。
