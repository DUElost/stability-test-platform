...
- Create: `tools/ansible/host_vars/172.21.10.36.yml`
- Create: `tools/ansible/roles/agent_deploy/defaults/main.yml`
- Create: `tools/ansible/roles/agent_deploy/handlers/main.yml`
- Test: `wsl bash -lc 'cd /mnt/f/stability-test-platform/tools/ansible && ANSIBLE_CONFIG=./ansible.cfg ansible-inventory -i inventory.ini --host 172.21.10.36'`
...
```bash
wsl bash -lc 'cd /mnt/f/stability-test-platform/tools/ansible && ANSIBLE_CONFIG=./ansible.cfg ansible-inventory -i inventory.ini --host 172.21.10.36'
```
...
```bash
git add tools/ansible/group_vars/linux_hosts.yml tools/ansible/host_vars/172.21.10.36.yml tools/ansible/roles/agent_deploy/defaults/main.yml tools/ansible/roles/agent_deploy/handlers/main.yml
...
```bash
wsl bash -lc "cd /mnt/f/stability-test-platform/tools/ansible && ANSIBLE_CONFIG=./ansible.cfg ansible-playbook playbooks/service_agent.yml --limit 172.21.10.36 -e agent_service_action=status"
```
