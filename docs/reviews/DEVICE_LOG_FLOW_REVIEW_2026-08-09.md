...
- `find_event_dir_under_root`（[`aee_event_dirs.py:78`](../../backend/agent/contracts/aee_event_dirs.py)）遍历目录树取**字典序第一个匹配**——两台设备产生同名事件目录时，第二台被静默跳过
