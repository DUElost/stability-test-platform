...
| R01–R15 | 逐区**静态只读审查已交付**，15 个台账均已收口（R02/#910 于 2026-09-16 收口）；逐区口径为「待验证」。逐区明细见 §5.1 |
...
### 5.1 逐区状态（2026-09-14 实查核对；R02 行为 2026-09-16 收口更新）
...
| R02 认证、授权与安全边界 | [#910](https://github.com/DUElost/stability-test-platform/issues/910) | 待验证 | 09-07 | `963bdd18` | 7 缺陷 + 4 风险；**台账已于 09-16 收口 CLOSED**（复核基线 `6b21e3b2`：F01–F05 于 09-14、F06/F07 于 09-16 逐条回源码，7/7 闭环；#906/#91 留 OPEN 由自身 issue 继续追踪） |
...
- R02 曾单记「进行中」（本轮唯一未关闭台账），09-16 收口后与其余 14 区同记
  「待验证」：台账关闭只代表登记面收口（子单 CLOSED 或去向登记），
  不改变「审查已交付、结论待动态验证」的区状态口径。
