...
| **架构 ADR** | [`adr/ADR-0035-agent-host-identity.md`](./adr/ADR-0035-agent-host-identity.md) | Agent 主机身份与凭据体系（全局 AGENT_SECRET+自报 host_id 的冒充面/四方案对比/推荐 A 每主机凭据+C 注册质询引入；**Accepted v1.0**（2026-09-08 用户裁决）；R02-R01/#906，实施单另行拆分） |
