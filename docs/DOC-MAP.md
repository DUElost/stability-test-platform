...
| **架构 ADR** | [`adr/ADR-0033-tool-kit-ecosystem-integration.md`](./adr/ADR-0033-tool-kit-ecosystem-integration.md) | 外部工具统一接入契约规范与包管理解耦模型（三层宿主/Tool Contract 退出码分层/Manifest 发布格式×DB catalog 唯一权威/防腐适配器/与 ADR-0032 权威分家；D0·D3 权威即刻生效、D2 按族准入、包存储条件落地、legacy 例外登记；**落地状态：未落地**（Phase 2 控制面样板 2026-09-18 阻塞，见 notes）；Accepted v1.4；#745/#2546） |
