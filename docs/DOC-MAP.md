...
| **架构 ADR** | [`adr/ADR-0051-release-unit-and-content-addressing.md`](./adr/ADR-0051-release-unit-and-content-addressing.md) | 发布单元与内容寻址——不可变性从源码目录移到包。**Accepted v1.5，落地未完结**：Phase 0/2a/2b/3 已落地；现站 48/48 包模式、在位缺口 0；Phase 1/4/5 部分落地，独立站点完整可复现与过渡退出仍待收口。详见正文状态与 [2026-09-25 生产验收](./notes/process/2026-09-25-adr0051-production-acceptance.md)。 |
