# 2026-07-28 198.51.100.126 硬挂事故复盘与处置记录

> **状态**：已闭环（host 已恢复，watchdog / EEE / BIOS / Agent restart 四项加固就位）。
> **影响范围**：单台 Agent host（`198.51.100.126`，Dell OptiPlex 7090，Service Tag H2884R3），无测试任务数据丢失，无控制面侧影响。
...
## 3. 已执行的加固措施（仅作用于 198.51.100.126）
...
|----|------|-----------|----------|-------|------|
| 192.0.2.87  | OptiPlex 3090 | 2.4.0 | 04/09/2022 | NO | ⚠ 出厂 BIOS；2026-07-29 xHCI 死亡见 [8.87 USB 事故](./incident-2026-07-29-host-8-87-xhci-death-and-adb-outage.md) |
| 192.0.2.103 | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 192.0.2.116 | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 192.0.2.143 | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 192.0.2.192 | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 192.0.2.195 | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 198.51.100.6   | OptiPlex 3090 | 2.4.0 | 04/09/2022 | NO | ⚠ 出厂 BIOS |
| 198.51.100.93  | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 198.51.100.112 | OptiPlex 3090 | 2.28.0 | 11/30/2025 | NO | 较新 |
| 198.51.100.114 | OptiPlex 3090 | 2.28.0 | 11/30/2025 | NO | 较新 |
| 198.51.100.116 | OptiPlex 3090 | 2.28.0 | 11/30/2025 | NO | 较新 |
| 198.51.100.124 | OptiPlex 3090 | 2.28.0 | 11/30/2025 | NO | 较新 |
| 198.51.100.127 | OptiPlex 3090 | 2.28.0 | 11/30/2025 | NO | 较新 |
| 198.51.100.128 | OptiPlex 3090 | 2.1.1 | 12/13/2021 | NO | ⚠ 出厂 BIOS |
| 198.51.100.123 | OptiPlex 3080 | 2.34.0 | 12/01/2025 | NO | 较新 |
| 198.51.100.131 | OptiPlex 3080 | 2.34.0 | 12/01/2025 | NO | 较新 |
| 198.51.100.132 | OptiPlex 3080 | 2.34.0 | 12/01/2025 | NO | 较新 |
| 198.51.100.117 | Inspiron 3910  | 1.0.3 | 11/13/2021 | NO | ⚠ 出厂 BIOS |
| 198.51.100.121 | Inspiron 3910  | 1.0.3 | 11/13/2021 | NO | ⚠ 出厂 BIOS |
| 198.51.100.126 | OptiPlex 7090  | 1.42.0 | 04/23/2026 | YES | ✓ 本次事故 host，已升级 |
...
> **决策（2026-07-29）：本节整体冻结，不作为后续行动项。**
>
> - 19 台 host 的 watchdog / EEE / Agent restart / fwupd / BIOS 升级**一律不主动推进**，保持现状。
> - 本节内容仅作**事故知识留档**：记录当时的风险分组（§4.3）与推广路径，供复发时直接取用，不代表待办队列。
> - **解冻条件**：再次出现同类硬挂（host 无响应且 `journalctl -b -1` 无 clean shutdown 记录）。届时按 §5.1 顺序对**受影响机型**执行，仍需 PR + 灰度 + 回退预案。
> - 无故障则不做任何下一步操作 —— §4.3 的 C 组「11 台 2021-2022 出厂 BIOS」标注的是**潜在**风险，不是已确认缺陷，不构成主动升级理由。
...
```bash
# 在 198.51.100.126 上撤销本次 OS 层加固（任一项均可独立回退）
