...
| [ADR-0051](./ADR-0051-release-unit-and-content-addressing.md) | 发布单元与内容寻址——不可变性从源码目录移到包（#735 / #3075 / #1987 / #2386） | **Accepted** | P1 | M7 | v1.5：2026-09-25 **未完结**。现站 48/48 包模式、在位缺口 0；Phase 0/2a/2b/3 已落地，Phase 1/4/5 部分落地。#3262 已收口 manifest retired 数据策略；仍待新站 `default_params`、生产 env 脱离开发检出、flashtool/aimonkey 与控制面 dedup 工具包化、legacy env/回退和治理减法。完整证据与历史修订见正文。 |
