...
| M7 | 进行中 | **Proposed（未决）**：ADR-0039、ADR-0046、ADR-0047。<br>**Accepted**：ADR-0029（M1–M4 已落地）、0030、0031、0032、0033（v1.10；§5.6 D0=带外部资产的族；部分落地）、0034、0036、0037、0038、0040、0042、0043（实施已落地）、0044、0045（词表已落地 `adf9c24a`）、0048、0049、0050。 |
