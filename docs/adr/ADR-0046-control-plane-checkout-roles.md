...
- 状态：**Superseded** by [ADR-0051](./ADR-0051-release-unit-and-content-addressing.md) D6（2026-09-22：D1 是 / D2 退役改显式动作 / D3 三路径同根不新增 env / D4 部署动作唯一推进 / D5 需要回滚→选 **B** / D6 审计落 digest。正文保留为判据与事故记录）
