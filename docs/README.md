...
| [`2026-device-log-chain-contract.md`](./design/2026-device-log-chain-contract.md) | 设备日志链路 Living Contract（全链地图 + 逻辑坐标 + Central namespace；非 ADR；细节展开见 global-semantics） |
