...
| [`2026-09-multi-site-installation.md`](./design/2026-09-multi-site-installation.md) | 多站点 P1：I1 配置模型与离线校验、I2 发布清单检查与脱敏 `plan` 已实现；HTTPS 模板域名/证书占位符化；安装编排与城市 B 闭环仍待实施 |
