...
- **10 条存量场景缺口**（`_SCENARIO_COVERAGE_DEBT`）→ **#2236：已收口**（17/17 全覆盖、清单清空、判据保留；另加逐条判别力常驻用例，见 `docs/notes/testing/2026-09-16-alert-scenario-debt-clearance-2236.md`）。原计划：逐条补
