...
待实施的后续工作（本 PR 不开单也不实施，由各 ADR 已有的实施单或后续单承接）：#3159（D9 + D9.8）、
#3244（ADR-0052）、#3308 Phase C（ADR-0053 D7）、ADR-0012 第 2 层、ADR-0023 D2–D4 与 D6 源头守卫、
灰机 `192-0-2-143` 的 `PRUNE_LOCAL` 回退为 0（运维动作）。
