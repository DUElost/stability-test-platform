...
| 规则 | 为什么 |
|---|---|
| **同 ID 以最新状态覆盖** | 历史不得掩盖刚发生的失败：上一轮 S5 PASS、这一轮 S5 FAIL ⇒ 取 FAIL。**注**：该承诺当时只覆盖「同 ID」——互斥候选之间的新鲜度由 **#2852** 补齐（[`2026-09-20-handover-evidence-freshness-2852.md`](./2026-09-20-handover-evidence-freshness-2852.md)），桶值随之带 `run` 序号 |
