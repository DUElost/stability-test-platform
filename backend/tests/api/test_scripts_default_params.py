...
class TestScriptDefaultParamsAPI:
    def test_create_with_default_params(self, client):
        name = _uniq("dp_test")
        payload = {
    ...
    def test_update_rejects_default_params_change(self, client):
        name = _uniq("dp_lock")
        payload = {
        ...
        create = client.post("/api/v1/scripts", json=payload)
    ...
    def test_update_allows_same_default_params(self, client):
        name = _uniq("dp_same")
        payload = {
    ...
    def test_param_schema_is_still_mutable(self, client):
    ...
    def test_version_create_requires_default_params(self, client):
        name = _uniq("dp_ver")
        payload = {
    ...
    def test_list_scripts_includes_default_params(self, client):
        name = _uniq("dp_list")
        payload = {
        ...
        client.post("/api/v1/scripts", json=payload)
        resp = client.get("/api/v1/scripts", params={"is_active": True})
