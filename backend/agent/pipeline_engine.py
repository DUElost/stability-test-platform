...
class PipelineEngine:
    ...
    def __init__(
        ...
        self._timeout_workers: list = []  # Track abandoned timeout threads for drain
    ...
    def drain_workers(self, grace_seconds: int = 5) -> None:
        """Wait for any abandoned timeout worker threads to finish.

        Call during teardown / lifecycle exit to give abandoned threads
        a chance to complete before the process exits.
        """
