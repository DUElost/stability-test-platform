...
from ..contracts.aee_metadata import normalize_aee_event_type, normalize_aee_subtype
...
def state_key(serial: str, aee_type: str, *, prefix: str = WATCHER_AEE_STATE_PREFIX) -> str:
