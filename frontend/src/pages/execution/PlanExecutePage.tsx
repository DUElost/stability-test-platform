    ...
    <PageContainer width="wide">
      ...
      <form onSubmit={handlePreview} className="space-y-4">
        ...
        <div className="sticky bottom-3 z-20 flex flex-col gap-3 rounded-xl border bg-background/95 p-3 shadow-lg backdrop-blur sm:flex-row sm:items-center">
          ...
          {currentStep === 0 ? <Button type="button" variant="outline" onClick={() => navigate('/orchestration/plans')}>取消</Button> : <Button type="button" variant="outline" onClick={() => handleStepChange(currentStep - 1)}><ChevronLeft className="mr-1.5 h-4 w-4" />上一步</Button>}
