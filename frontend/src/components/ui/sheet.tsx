...
// 右侧滑出层（shadcn Sheet 形态）。@radix-ui/react-dialog 已在依赖中，
// 无需新包——与 GitHub issue pane 同类的「抽屉式渐进披露」载体，供列表行内
// 快速查看/编辑而不离开上下文。
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn("mt-auto flex justify-end gap-2 pt-2", className)}
    {...props}
  />
)
